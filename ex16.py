...
try: 
    ...
    # w+ doesn't seem to open in append mode. Trying r+. r+ has the same problem. Will now attempt a+. Wonder why a+ and not a simply. So a+ creates a new file if it doesn't exist. r+ doesn't (and positions pointer at start of file to overwrite). a+ will open the file up for reading as well, a alone will open this up only for writing. https://stackoverflow.com/questions/1466000/difference-between-modes-a-a-w-w-and-r-in-built-in-open-function 
